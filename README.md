[![Run App Poling](https://github.com/ppoling6/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ppoling6/GithubActions/actions/workflows/run-app.yaml)
